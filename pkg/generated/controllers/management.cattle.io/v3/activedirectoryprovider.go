...
type ActiveDirectoryProviderController interface {
	generic.NoNsControllerInterface[*v3.ActiveDirectoryProvider, *v3.ActiveDirectoryProviderList]
}
...
type ActiveDirectoryProviderClient interface {
	generic.NoNsClientInterface[*v3.ActiveDirectoryProvider, *v3.ActiveDirectoryProviderList]
}
...
type ActiveDirectoryProviderCache interface {
	generic.NoNsCacheInterface[*v3.ActiveDirectoryProvider]
}
