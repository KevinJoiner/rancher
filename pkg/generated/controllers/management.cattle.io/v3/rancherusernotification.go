...
type RancherUserNotificationController interface {
	generic.NoNsControllerInterface[*v3.RancherUserNotification, *v3.RancherUserNotificationList]
}
...
type RancherUserNotificationClient interface {
	generic.NoNsClientInterface[*v3.RancherUserNotification, *v3.RancherUserNotificationList]
}
...
type RancherUserNotificationCache interface {
	generic.NoNsCacheInterface[*v3.RancherUserNotification]
}
