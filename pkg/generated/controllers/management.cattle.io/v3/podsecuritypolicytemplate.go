...
type PodSecurityPolicyTemplateController interface {
	generic.NoNsControllerInterface[*v3.PodSecurityPolicyTemplate, *v3.PodSecurityPolicyTemplateList]
}
...
type PodSecurityPolicyTemplateClient interface {
	generic.NoNsClientInterface[*v3.PodSecurityPolicyTemplate, *v3.PodSecurityPolicyTemplateList]
}
...
type PodSecurityPolicyTemplateCache interface {
	generic.NoNsCacheInterface[*v3.PodSecurityPolicyTemplate]
}
