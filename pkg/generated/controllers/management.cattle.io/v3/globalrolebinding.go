...
type GlobalRoleBindingController interface {
	generic.NoNsControllerInterface[*v3.GlobalRoleBinding, *v3.GlobalRoleBindingList]
}
...
type GlobalRoleBindingClient interface {
	generic.NoNsClientInterface[*v3.GlobalRoleBinding, *v3.GlobalRoleBindingList]
}
...
type GlobalRoleBindingCache interface {
	generic.NoNsCacheInterface[*v3.GlobalRoleBinding]
}
