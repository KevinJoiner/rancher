...
type PodSecurityAdmissionConfigurationTemplateController interface {
	generic.NoNsControllerInterface[*v3.PodSecurityAdmissionConfigurationTemplate, *v3.PodSecurityAdmissionConfigurationTemplateList]
}
...
type PodSecurityAdmissionConfigurationTemplateClient interface {
	generic.NoNsClientInterface[*v3.PodSecurityAdmissionConfigurationTemplate, *v3.PodSecurityAdmissionConfigurationTemplateList]
}
...
type PodSecurityAdmissionConfigurationTemplateCache interface {
	generic.NoNsCacheInterface[*v3.PodSecurityAdmissionConfigurationTemplate]
}
