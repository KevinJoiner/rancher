...
func newMockController(t *testing.T) *mockController {
	...
	clusterCache := fake.NewMockNoNsCacheInterface[*v3.Cluster](ctrl)
...
type mockController struct {
	...
	mockClusterCache *fake.MockNoNsCacheInterface[*v3.Cluster]
	...
	mockGRBCache     *fake.MockNoNsCacheInterface[*v3.GlobalRoleBinding]
}
