...
func simpleHandler(t *testing.T) *handler {
	...
	mockMgmtCluster := fake.NewMockNoNsCacheInterface[*apisv3.Cluster](ctrl)
	...
	mockClusterRoleController := fake.NewMockNoNsControllerInterface[*rbacv1.ClusterRole, *rbacv1.ClusterRoleList](ctrl)
	mockClusterRoleController.EXPECT().EnqueueAfter(gomock.Any(), gomock.Any()).AnyTimes()

	mockClusterRoleBindingController := fake.NewMockNoNsControllerInterface[*rbacv1.ClusterRoleBinding, *rbacv1.ClusterRoleBindingList](ctrl)
