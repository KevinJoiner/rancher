...
func TestSetAll(t *testing.T) {
	settingClient := fake.NewMockNoNsControllerInterface[*v3.Setting, *v3.SettingList](gomock.NewController(t))
	...
	cannotCreateClient := fake.NewMockNoNsControllerInterface[*v3.Setting, *v3.SettingList](gomock.NewController(t))
	testSettingsProvider = settingsProvider{
	...
	cannotUpdateClient := fake.NewMockNoNsControllerInterface[*v3.Setting, *v3.SettingList](gomock.NewController(t))
	testSettingsProvider = settingsProvider{
		settings: cannotCreateClient,
	}
	...
	alreadyExistsCreateClient := fake.NewMockNoNsControllerInterface[*v3.Setting, *v3.SettingList](gomock.NewController(t))
	testSettingsProvider = settingsProvider{
