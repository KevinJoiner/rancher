...
func newMockCleanupService(t *testing.T,
	...
	grbCache := fake.NewMockNoNsCacheInterface[*v3.GlobalRoleBinding](ctrl)
	...
	grbClient := fake.NewMockNoNsClientInterface[*v3.GlobalRoleBinding, *v3.GlobalRoleBindingList](ctrl)
	...
	userCache := fake.NewMockNoNsCacheInterface[*v3.User](ctrl)
	...
	userClient := fake.NewMockNoNsClientInterface[*v3.User, *v3.UserList](ctrl)
